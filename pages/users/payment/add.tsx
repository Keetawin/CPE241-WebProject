  ...
  const handleSubmit = async (event: any) => {
    ...
    if (paymentMethod == "Credit Card") {
      body = {
        ...
        expired_date:
          (expireDate.$d &&
            new Date(expireDate.$d).toISOString().split("T")[0]) ||
          expireDate,
      };
    ...
    if (missingValue.length == 0) {
      try {
        axios
          .post("https://ticketapi.fly.dev/create_user_payment", body)
          .then((res) => {
            console.log(res);
            if (res.status == 200) {
              setAlert("success");
        ...
        <div className="flex">
          ...
          <div className="pl-10 w-full">
            ...
            >
              ...
              <h1 className="text-2xl font-semibold text-[#060047] mb-5">
                Payment Infomation
              </h1>
              <ToggleButtonGroup
                value={paymentMethod}
              ...
              >
                <ToggleButton value="Credit Card">Credit Card</ToggleButton>
                <ToggleButton value="Prompt Pay">Prompt pay</ToggleButton>
              </ToggleButtonGroup>
